		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/typeProduct">Тип товару</a></li>
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-horizontal" action="/admin/typeProduct"
	...
	<div class="col-md-7 col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<form:select class="form-control" path="category"
								itemLabel="nameCategory" itemValue="id" items="${categories}" />
		...
		<c:forEach items="${page.content}" var="typeProduct">
			<div class="row">
				<div class="col-md-3 col-xs-3">${typeProduct.nameTypeProduct}</div>
				<div class="col-md-3 col-xs-3">${typeProduct.category.nameCategory}</div>

				<div class="col-md-2 col-xs-2">
					<a class="btn btn-warning"
						href="/admin/typeProduct/update/${typeProduct.id}">Оновити</a>
				</div>
				<div class="col-md-2 col-xs-2">
					<a class="btn btn-danger"
						href="/admin/typeProduct/delete/${typeProduct.id}">Видалити</a>
				</div>
			</div>
		</c:forEach>
	</div>
