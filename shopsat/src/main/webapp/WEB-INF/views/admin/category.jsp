		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/category">Категорія</a></li>
			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/category"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<form:input type="text" class="form-control" path="nameCategory"
								id="name" />
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-md-2 col-xs-2">
					<a class="btn btn-warning"
						href="/admin/category/update/${category.id}">update</a>
				</div>
				<div class="col-md-2 col-xs-2">
