		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/country">Країна</a></li>
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
				...
				<form:form class="form-horizontal" action="/admin/country"
					...
					<div class="form-group">
						<label for="name" class="col-sm-offset-2 col-sm-10"><form:errors
								path="nameCountry" /></label>
					</div>

					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Назва</label>
						<div class="col-sm-10">
							<form:input type="text" class="form-control" path="nameCountry"
								id="name" />
						</div>
					</div>
		...
		<c:forEach items="${page.content}" var="country">
			<div class="row">
				<div class="col-md-4 col-xs-4">${country.nameCountry}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/country/update/${country.id}">Оновити</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/country/delete/${country.id}">Видалити</a>
				</div>
			</div>
		</c:forEach>
	</div>
		...
		<div class="col-md-6 col-xs-6 text-center">
			<div class="dropdown">
				...
				<ul class="dropdown-menu">
					<custom:sort innerHtml="Name asc" paramValue="nameCountry" />
					<custom:sort innerHtml="Name desc" paramValue="nameCountry,desc" />
				</ul>
			</div>
		</div>
		<div class="col-md-6 col-xs-6 text-center">
